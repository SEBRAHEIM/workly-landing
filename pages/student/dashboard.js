  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (role !== "student") { window.location.href = "/creator/dashboard"; return; }
    ...
    <div style={{ minHeight: "100vh", background: "#ece9e2", padding: 24 }}>
      <div style={{ maxWidth: 900, margin: "0 auto", background: "#fff", borderRadius: 18, padding: 18, border: "1px solid rgba(0,0,0,0.10)" }}>
        ...
        <div style={{ marginTop: 16, display: "grid", gap: 10 }}>
          ...
          <Link href="/categories/reports-essays" style={{ padding: 14, borderRadius: 14, border: "1px solid rgba(0,0,0,0.10)", background: "rgba(0,0,0,0.03)", fontWeight: 1000, color: "#3a332b", textDecoration: "none" }}>
            Browse categories
          </Link>
        </div>
      </div>
