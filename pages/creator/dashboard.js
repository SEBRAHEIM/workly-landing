  ...
  return (
    <div style={{ minHeight: "100vh", background: "#ece9e2", padding: 24 }}>
      <div style={{ maxWidth: 900, margin: "0 auto", background: "#fff", borderRadius: 18, padding: 18, border: "1px solid rgba(0,0,0,0.10)" }}>
        ...
        <div style={{ marginTop: 14, fontWeight: 1200, fontSize: 30, color: "#3a332b" }}>Creator dashboard</div>
        <div style={{ marginTop: 8, opacity: 0.75, fontWeight: 900 }}>You’re signed in as a Creator.</div>
        <div style={{ marginTop: 14, display: "flex", gap: 10, flexWrap: "wrap" }}>
          <Link href="/creator/requests" style={{ padding: "10px 14px", borderRadius: 999, border: "1px solid rgba(0,0,0,0.12)", textDecoration: "none", fontWeight: 1000, color: "#4b443b" }}>Requests</Link>
        </div>
      </div>
    </div>
  );
